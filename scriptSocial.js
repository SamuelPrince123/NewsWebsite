...
async function loadData() {
  const container = document.getElementById("socialIssuesContent");
  const socialIssuesRef = collection(db, "social_issues_and_movement"); // Reference to 'social_issues' collection
  const querySnapshot = await getDocs(socialIssuesRef);
