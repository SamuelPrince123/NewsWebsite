...
async function loadData() {
  const container = document.getElementById("archaeologyContent");
  const climateRef = collection(db, "archaeology_and_history"); // Reference to 'climate' collection
  const querySnapshot = await getDocs(climateRef);
